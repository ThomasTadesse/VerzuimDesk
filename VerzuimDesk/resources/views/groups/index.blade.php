                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 border-b border-gray-300 dark:border-gray-700">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('groups.show', $group) }}" class="px-2 py-1 text-xs bg-blue-500 text-white rounded hover:bg-blue-600">
                                                    View
                                                </a>
                                                <a href="{{ route('groups.edit', $group) }}" class="px-2 py-1 text-xs bg-yellow-500 text-white rounded hover:bg-yellow-600">
                                                    Edit
                                                </a>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="px-4 py-2 text-center">No groups found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
