                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700">
                            <thead>
                                <tr>
                                    <th class="px-4 py-2 border-b border-gray-300 dark:border-gray-700 text-left">Date</th>
                                    <th class="px-4 py-2 border-b border-gray-300 dark:border-gray-700 text-left">Student</th>
                                    <th class="px-4 py-2 border-b border-gray-300 dark:border-gray-700 text-left">Teacher</th>
                                    <th class="px-4 py-2 border-b border-gray-300 dark:border-gray-700 text-left">Subject</th>
                                    <th class="px-4 py-2 border-b border-gray-300 dark:border-gray-700 text-left">Group</th>
                                    <th class="px-4 py-2 border-b border-gray-300 dark:border-gray-700 text-left">Present %</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 border-b border-gray-300 dark:border-gray-700">
                                            <div class="flex space-x-2">
                                                <a href="{{ route('attendances.show', $attendance) }}" class="px-2 py-1 text-xs bg-blue-500 text-white rounded hover:bg-blue-600">
                                                    View
                                                </a>
                                                <a href="{{ route('attendances.edit', $attendance) }}" class="px-2 py-1 text-xs bg-yellow-500 text-white rounded hover:bg-yellow-600">
                                                    Edit
                                                </a>
                                                <form action="{{ route('attendances.destroy', $attendance) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                                    @csrf
                                                    @method('DELETE')
