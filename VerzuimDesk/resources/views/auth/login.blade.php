<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <x-text-input id="email" class="block p-2 mt-1 w-full" type="email" name="email" :value="old('email')"
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox"
                    ...
                    name="remember">
                <span class="ms-2 text-sm text-gray-400 dark:text-gray-300">{{ __('Remember me') }}</span>
            </label>
        </div>
